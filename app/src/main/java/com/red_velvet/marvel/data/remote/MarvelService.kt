...
import com.red_velvet.marvel.data.model.GetComicByComicIdResponse
...
interface MarvelService {
    ...
    @GET("comics/{comicId}")
    fun getComicDetail(@Path("comicId") comicId: Int): Single<BaseResponse<GetComicByComicIdResponse>>
