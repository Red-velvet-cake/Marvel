...
class EventsFragment() : BaseFragment<FragmentEventsBinding>() {
    ...
    override val viewModel: BaseViewModel = EventsViewModel()
    override fun setUp() {
        val eventsViewModel = viewModel as EventsViewModel
        val adapter = EventsAdapter(emptyList(), eventsViewModel)
        ...
        binding.editTextSearch.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                eventsViewModel.getAllEvents(s.toString())
            }
